...
MODEL_FILE = r"D:\Projects\CTS project\Model\SK _ Model\New Model\classifier_chain_gpu_model_v2.joblib"
...
def predict_patient_risk(patient_data: dict):
    ...
    for i, condition in enumerate(CONDITIONS):
        ...
        predicted_outcomes.append({
            "condition": condition.replace('HAD_', '').replace('_IN_2010', ' ').replace('_', ' ').strip().replace('ACUTE', 'SEVERE'),
